...
if __name__ == "__main__":
    y = np.loadtxt("C:\Users\shrainik\Desktop\ML\HW1\Data\star_labels.txt", dtype=np.int)
    # Load a text file of strings:
    featureNames = open("C:\Users\shrainik\Desktop\ML\HW1\Data\star_features.txt").read().splitlines()
    # Load a matrix market matrix, convert it to csc format:
    A = io.mmread("C:\Users\shrainik\Desktop\ML\HW1\Data\star_data.mtx").tocsc()
