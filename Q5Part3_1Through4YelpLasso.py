...
if __name__ == "__main__":
    y = np.loadtxt("C:\Users\shrainik\Desktop\ML\HW1\Data\upvote_labels.txt", dtype=np.int)
    # Load a text file of strings:
    featureNames = open("C:\Users\shrainik\Desktop\ML\HW1\Data\upvote_features.txt").read().splitlines()
    # Load a csv of floats:
    A = np.genfromtxt("C:\Users\shrainik\Desktop\ML\HW1\Data\upvote_data.csv", delimiter=",")
